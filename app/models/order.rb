class Order < ActiveRecord::Base
  ...
  scope :filterByIdOrNameOrAdvertiser, lambda {|query| where("name ILIKE ? or source_id ILIKE ? or io_details.client_advertiser_name ILIKE ?","%#{query}%","%#{query}%","%#{query}%") unless query.blank? }
