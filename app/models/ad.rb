class Ad < ActiveRecord::Base
  ...
  before_create :create_random_source_id       before_save :move_end_date_time, :set_data_source, :set_type_params, :set_default_status, :set_platform_site, :set_est_flight_dates
