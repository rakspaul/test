class Admin::ReachClientsController < ApplicationController
  ...
  def create
    p = params.require(:reachClient).permit(:name, :abbr, :address, :sales_person_id, :account_manager_id)
  ...
  def update
    ...
    p = params.require(:reachClient).permit(:name, :abbr, :address, :sales_person_id, :account_manager_id, :media_contact_id, :billing_contact_id)
