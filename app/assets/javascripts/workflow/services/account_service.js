    ...
    angObj.factory("accountsService", function (apiPaths,dataService,constants,requestCanceller) {
        ...
        return {
            getAllCurrency: function () {
                var url = apiPaths.WORKFLOW_API_URL + '/currencies';
                return dataService.fetch(url);
            },
            createBillableAccount: function (data) {
                return dataService.post(apiPaths.WORKFLOW_API_URL +'/billable_accounts', data,{'Content-Type': 'application/json'})

            },
            createAgencies: function (data) {
                return dataService.post(apiPaths.WORKFLOW_API_URL +'/agencies', data,{'Content-Type': 'application/json'})

            },
            getCountries:function(){
                var url = apiPaths.WORKFLOW_API_URL + '/countries';
                return dataService.fetch(url);
            },
            getAllAdvertisers: function () {
                var url = apiPaths.WORKFLOW_API_URL + '/advertisers';
                return dataService.fetch(url, {cache:false});
            },
            getAgencies: function () {
                var url = apiPaths.WORKFLOW_API_URL + '/agencies';
                return dataService.fetch(url, {cache:false});
            },
            getAllBrands: function () {
                var url = apiPaths.WORKFLOW_API_URL + '/brands';
                return dataService.fetch(url, {cache:false});
            },
            getClients: function (success, failure,flag) {
                var url = apiPaths.WORKFLOW_API_URL + '/clients?access_level=admin';
                if(flag == 'cancellable'){
            ...
            getAdvertisersBrand: function(clientId,advertiserId) {
                var url = apiPaths.WORKFLOW_API_URL + '/clients/'+clientId+'/advertisers/'+advertiserId+'/brands';
                return dataService.fetch(url, {cache:false});
            },
            updateAdvertiser : function(data,id) {
                return dataService.put(apiPaths.WORKFLOW_API_URL +'/advertisers/'+id, data, {'Content-Type': 'application/json'})
            },
            createAdvertiser : function(data) {
                return dataService.post(apiPaths.WORKFLOW_API_URL +'/advertisers',data, {'Content-Type': 'application/json'})
            },
            createAdvertiserUnderClient : function(clientId,advertiserId) {
                return dataService.put(apiPaths.WORKFLOW_API_URL +'/clients/'+clientId+'/advertisers/'+advertiserId,{}, {'Content-Type': 'application/json'})
            },
            createBrand : function(data) {
                return dataService.post(apiPaths.WORKFLOW_API_URL +'/brands',data, {'Content-Type': 'application/json'})
            },
            createBrandUnderAdvertiser : function(clientId,advertiserId,brandId) {
                return dataService.put(apiPaths.WORKFLOW_API_URL +'/clients/'+clientId+'/advertisers/'+advertiserId+'/brands/'+brandId,{}, {'Content-Type': 'application/json'})
            }
            ,
            updateBrand : function(data,id) {
                return dataService.put(apiPaths.WORKFLOW_API_URL +'/brands/'+id, data, {'Content-Type': 'application/json'})
            },
            updateClient : function(data,id) {
                return dataService.put(apiPaths.WORKFLOW_API_URL +'/clients/'+id, data, {'Content-Type': 'application/json'})
            },
            createClient : function(data) {
                return dataService.post(apiPaths.WORKFLOW_API_URL +'/clients',data, {'Content-Type': 'application/json'})
            },
            ...
            getUsers: function () {
                var url = apiPaths.WORKFLOW_API_URL + '/users';
                return dataService.fetch(url,{cache: false});
            },
            getUsersDetails: function (id) {
                var url = apiPaths.WORKFLOW_API_URL + '/users/'+id;
                return dataService.fetch(url,{cache: false});
            },
            ...
            createUser: function(userObj){
                return dataService.post(apiPaths.WORKFLOW_API_URL +'/users', userObj,{'Content-Type': 'application/json'})
            },
            updateUser : function(data,fetchedUserDetails) {
                data.id = fetchedUserDetails.id;
                data.updatedAt = fetchedUserDetails.updatedAt;
                return dataService.put(apiPaths.WORKFLOW_API_URL +'/users/'+data.id, data, {'Content-Type': 'application/json'})
            },
