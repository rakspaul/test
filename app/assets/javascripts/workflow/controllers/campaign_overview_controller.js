        ...
        var campaignOverView = {
            ...
            getAdsForCampaign :  function(campaignId) {
                workflowService.getAdsForCampaign(campaignId).then(function (result) {
                    if (result.status === "OK" || result.status === "success") {
                        var responseData = result.data.data;   $scope.extractor(responseData);
            ...
            getAdsInAdGroup:function(campaignId,adGroupId,index) { console.log(index);
                     workflowService.getAdsInAdGroup(campaignId,adGroupId).then(function (result) {
                         if (result.status === "OK" || result.status === "success") {
                             var responseData = result.data.data;
                                 $scope.workflowData['getADsForGroupData'][index] = responseData;   console.log($scope.workflowData);
                         }
                         else{
                             campaignOverView.errorHandler(result);
                         }
