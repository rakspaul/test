...
(function () {
    ...
    angObj.controller('GeoTargettingController',
        function ($scope, $rootScope, $window, $routeParams, constants, workflowService, $timeout, utils,
                  $location, zipCode,audienceService) {
        var citiesListArray= [],
            regionsListArray= [],
            dmasListArray = [],
        ...
        $scope.updateGeoTargets =  function () {
          $('#geographyTargeting').show().delay(300).animate({
              left: '50%',
              marginLeft: '-461px',
              opacity: '1.0'
          }, 'slow');
        ...
        $scope.selectDayTarget = function () {
            ...
            //$scope.resetGeoTargetingVariables();
            $('#dayTargeting').show().delay(300).animate({
                left: '50%',
                marginLeft: '-461px',
                opacity: '1.0'
            }, 'slow');
        ...
        $scope.resetAudienceTargetingVariables = function () {
            ...
            $('#audienceTargeting').delay(300).animate({
                left: '100%',
                marginLeft: '0px',
                opacity: '0.0'
            }, function () {
        ...
        $scope.changeSortingOrder = function (section) {
            if ($('.common-sort-icon').hasClass('ascending')) {
                $('.common-sort-icon').removeClass('ascending').addClass('descending');
                ...
                $('.common-sort-icon').removeClass('descending').addClass('ascending');
                if (section === 'regions') {
                    regionsListArray = [];
                    regionListSortOrder = 'asc';
                    $scope.listRegions();
