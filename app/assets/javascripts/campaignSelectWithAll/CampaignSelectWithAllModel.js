...
campaignSelectWithAllModule.factory("campaignSelectWithAllModel", ['urlService','dataService' ,'kpiSelectModel','constants', function (urlService,dataService,kpiSelectModel, constants) {
    var campaign = {};
    campaign.campaigns = {};
    ...
    campaign.getSelectedCampaign = function() {
        return (localStorage.getItem('selectedCampaignAll') == undefined)? campaign.selectedCampaign : JSON.parse(localStorage.getItem('selectedCampaignAll')) ;
    } ;
