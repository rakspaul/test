(function() {
    ...
    var constants = function ($locale) {
        ...
        this.TRANSPARENT_PLATFORM_FEE_CHARGED =
            'Transparent platform fee charged by Collective for technology and services ' +
            'associated with programmatic media activity';
        ...
        this.TAGTYPE = 'Type';
        this.SSL = 'SSL';
        this.YOUHAVENTADDED = 'You haven'\t added any Creative Tags for your Ad yet';
        this.COPY = 'Copy';
        this.DELETE = 'Delete';
