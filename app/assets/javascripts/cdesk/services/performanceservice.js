    ...
    angObj.factory("performanceService", function ($http,$location, api, apiPaths, common, campaign_api) {
        ...
        return {
            ...
            getStrategyPerfData: function (param) {
                console.log("get strategy perform data param");
                console.log(param);
            //    var url = 'http://dev-desk.collective-media.net:9000/dataapi/campaigns/405617/strategies/11133/byscreens/perf?start_date=2014-10-01&end_date=2014-10-31';
                var url = apiPaths.apiSerivicesUrl + '/campaigns/' + param.campaignId+ '/strategies/'+ param.strategyId+ '/'+ param.tab + '/perf?start_date=2014-10-01&end_date=2014-10-31' ;     //+ param.tabName + '/perf?start_date=' + param.startDate + '&end_date=' + param.endDate ;
                console.log(url);
                return this.fetch(url);
            },
            ...
            getTacticPerfData: function (param) {
               // var url = 'http://dev-desk.collective-media.net:9000/dataapi/campaigns/405617/strategies/11133/tactics/9690049/byscreens/perf?start_date=2014-10-01&end_date=2014-10-31' ;
                 var url =  apiPaths.apiSerivicesUrl + '/campaigns/' + param.campaignId+ '/strategies/'+ param.strategyId+ '/tactics/'+  param.tacticId +'/' + param.tab +'/perf?start_date=2014-10-01&end_date=2014-10-31' ;// + param.startDate + '&end_date=' + param.endDate ;
                    console.log(url);
                return this.fetch(url);
            },
