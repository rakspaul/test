...
(function (requirejs) {
  ...
  requirejs.config({
    ...
    shim: {
      ...
      'controllers-create_report_controller' : {deps: ['controllers-cost_controller']},
  ...
  //     'directives-strategylist':{deps: ['directives-reportfilters']},
    ...
    paths: {
      ...
      'controllers-create_report_controller':'controllers/create_report_controller',
  ...
  require([
          ...
          'kpiSelect-KpiSelectModel',
           ...
           'controllers-create_report_controller',
