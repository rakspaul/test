...
(function (requirejs) {
  ...
  requirejs.config({
    ...
    shim: {
      ...
      'reporting-models-CampaignCDBData':{deps: ['common-services-UrlService']},
      'reporting-models-CampaignCost':{deps: ['reporting-models-CampaignCDBData']},
      'reporting-models-CampaignModel':{deps: ['reporting-models-CampaignCost']},
      'common-services-DataStoreModel':{deps: ['reporting-models-CampaignModel']},
      'common-controllers-header_controller':{deps: ['common-services-DataStoreModel']},
      ...
      'reporting-controllers-GaugeController':{deps: ['common-d3-gauge']},
      'reporting-models-GaugeModel':{deps: ['reporting-controllers-GaugeController']},
      'common-d3-bubbleChart':{deps: ['reporting-models-GaugeModel']},
      'reporting-controllers-BubbleChartController':{deps: ['common-d3-bubbleChart']},
      'reporting-models-BubbleChartModel':{deps: ['reporting-controllers-BubbleChartController']},
      'common-d3-screenChart':{deps: ['reporting-models-BubbleChartModel']},
      'reporting-controllers-ScreenChartController':{deps: ['common-d3-screenChart']},
      'reporting-models-ScreenChartModel':{deps: ['reporting-controllers-ScreenChartController']},

      'common-d3-ganttChart':{deps: ['reporting-models-ScreenChartModel']},
      'reporting-controllers-GanttChartController':{deps: ['common-d3-ganttChart']},
      'reporting-models-GanttChartModel':{deps: ['reporting-controllers-GanttChartController']},
      ...
      'controllers-accounts_add_or_edit_advertiser_controller' : {deps: ['controllers-cost_controller']},
      'controllers-accounts_add_or_edit_brand_controller' : {deps: ['controllers-cost_controller']},
      'controllers-accounts_add_or_edit_controller' : {deps: ['controllers-cost_controller']},
      'controllers-users_add_or_edit_controller' : {deps: ['controllers-cost_controller']},
    ...
    paths: {
      ...
      'controllers-accounts_add_or_edit_advertiser_controller':'common/controllers/accounts/accounts_add_or_edit_advertiser_controller',
      'controllers-accounts_add_or_edit_brand_controller':'common/controllers/accounts/accounts_add_or_edit_brand_controller',
      'controllers-accounts_add_or_edit_controller':'common/controllers/accounts/accounts_add_or_edit_controller',
