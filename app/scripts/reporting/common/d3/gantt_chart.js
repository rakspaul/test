            ...
            function ($location, $rootScope, $window, loginModel, brandsModel) {
                ...
                function prev(timeDomainString) {
                    ...
                    if (moment(_.first(data).startDate).toDate() < moment(td[0]).toDate()) { // jshint ignore:line
                        switch (timeDomainString) {
                            ...
                            case 'month':
                                if (tdDay !== 1) {
                                    var firstDay = moment(td[0]).startOf('month').format('DD'); // jshint ignore:line
                ...
                function changeTimeDomain(timeDomainString) {
                    ...
                    switch (timeDomainString) {
                        ...
                        case 'month':
                            format = '%d';
                            e = moment().startOf('month').startOf('day').unix() * 1000; // jshint ignore:line
                        ...
                        case 'today':
                            format = '%d';
                            //monday to sunday
                            gantt.timeDomain([moment().startOf('day').subtract(3, 'days'), // jshint ignore:line
                        ...
                        case 'quarter':
                            ...
                            gantt.timeDomain([moment().month(qStart).startOf('month'), // jshint ignore:line
                ...
                function loadMoreItemToCalender(task, taskName, o) {
                    ...
                    _.each(tasks, function (item, i) { // jshint ignore:line
                        if (item.id === brandsModel.getSelectedBrand().id) {
                            ...
                            if (i) {
                                temp0 = $.extend({}, tasks[0]);
                                tasks[0] = $.extend({}, tasks[i]);
                                tasks[i] = $.extend({}, temp0);
                            }
                        }
                    });
                ...
                d3.gantt = function (cal_height) { // jshint ignore:line
                    var FIT_TIME_DOMAIN_MODE = 'fit',
                        CAMPAIGN_HEIGHT = 25,
                        CALENDAR_HEIGHT = (cal_height === undefined) ? MIN_CALENDAR_HEIGHT : cal_height,
                        CALENDAR_WIDTH = 1300,
                        isSingleBrand = false,
                    ...
                    // [ 0, height - margin.top - margin.bottom ], .1);
                        ...
                        initAxis = function (timeDomainString) {
                            ...
                            y = d3.scale.ordinal().domain(taskTypes).rangeRoundBands([0, range]); // jshint ignore:line
                    ...
                    function gantt(tasks, timeDomainString) {
                        ...
                        svg = d3 // jshint ignore:line
                            .select('#calendar_widget').select('.div-chart')
                            .append('svg')
                            // TODO - check if needed for cross browser support
                            // .attr({xmlns: 'http://www.w3.org/2000/svg',
                            //        xlink: 'http://www.w3.org/1999/xlink',
                    ...
                    gantt.draw = function (tasks, timeDomainString) {
                        ...
                        svg.call(d3.behavior.drag() // jshint ignore:line
                            ...
                            .on('drag', function () {
                                ...
                                if (dragInitiated) {
                                    ...
                                    d3.event.sourceEvent.stopPropagation(); // jshint ignore:line
                                    data = _.sortBy(tasks, function (o) { return o.start_date; }); // jshint ignore:line
                                    ...
                                    if (d3.event.dx < 0) { // jshint ignore:line
                                        if (moment(_.first(data).endDate).toDate() > // jshint ignore:line
                                            ...
                                            } else if (moment(_.first(data).endDate).toDate() < // jshint ignore:line
                                        ...
                                        if (moment(_.first(data).startDate).toDate() < // jshint ignore:line
                                            moment((td[0] - scale * d3.event.dx)).toDate()) { // jshint ignore:line
                                            // second line of defence to limit scroll to previous duration based on
                                            // the amount of drag :)
                                            gantt.timeDomain([td[0] - scale *
                                            d3.event.dx, td[1] - scale * d3.event.dx]); // jshint ignore:line
                                        } else {
                         ...
                         * @return True if it is in the past
                         *              False if it is not
                         */
                            ...
                            .on('click', function (d) {
                                ...
                                switch(tDomainString) {
                                    case 'year':
                                        ...
                                        f = moment(e).add(1, 'year').unix() * 1000; // jshint ignore:line
                                    ...
                                    case 'month':
                                        ...
                                        f = moment(e).add(31, 'days').endOf('day').unix() * 1000; // jshint ignore:line
                                    ...
                                    case 'quarter':
                                        ...
                                        f = moment(e).add(1, 'quarters').unix() * 1000; // jshint ignore:line
                                    ...
                                    case 'today':
                                        ...
                                        f = moment(e).add(1, 'weeks').endOf('day').unix() * 1000; // jshint ignore:line
                        ...
                        markerGroup.append('text')
                            ...
                            .attr('x', function () {
                                ...
                                textWidth =
                                    pastMarkerTextX + (pastMarkerText ? pastMarkerText.length : 0) + offset + padding;
                        ...
                        rectGroup
                            ...
                            .on('mouseout', function () {
                                ...
                                d3.select('.calendar_tooltip').style('display', 'none'); // jshint ignore:line
                            })
                            .transition()
                            .attr('transform', rectTransform);
                        ...
                        //markers
                            ...
                            campaignsBottomStroke =
                                ganttChartGroup.selectAll('.campaign_stroke').data(tasks, keyFunction),
                                ...
                                a
                                    ...
                                    .attr('width', function (d) {
                                        ...
                                        if (d.type === 'brand') {
                                            ...
                                            if (!isFuture(tdEdges[1], d.endDate) &&
                                ...
                                a
                                    ...
                                    .attr('width', function (d) {
                                        ...
                                        if (d.type === 'brand') {
                                            ...
                                            d.kpiStatus === undefined ||
                                            d.kpiStatus === 'Unknown') {
                                            // fix for removing the  rectangle that was sticking on the axis even
                                            // after campaigns were scrolled out of the view
                                            if (x(d.endDate) - x(d.startDate) === 0) {
                                                return 0;
                                            }
