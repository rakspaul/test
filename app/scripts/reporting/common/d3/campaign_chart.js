            ...
            return {
                ...
                link: function (scope, elem, attrs) {
                    ...
                    lineChartService = {
                        ...
                        createVariablesToDrawGraph: function (data) {
                            var _config = this.lineChartConfig,
                                ...
                                xAxisGen,
                                yAxisGen,
                                xScale = d3.time.scale().domain([data[0][xkeyVal], // jshint ignore:line
                                data[data.length - 1][xkeyVal]]).range([margin.left, width]),

                                yScale = d3 // jshint ignore:line
                                    .scale
                                    .linear()
                                    .domain([0, d3.max(data, function (d) { // jshint ignore:line
                                        return d[ykeyVal];
                            ...
                            xAxisGen = d3 // jshint ignore:line
                                .svg
                                .axis()
                                .scale(xScale)
                                .orient('bottom')
                                .ticks(ticksData)
                                .tickFormat(d3.time.format('%_d %b')) // jshint ignore:line
                                .tickSize(0);

                            //tick control
                            if (!_config.isPerformanceChart && data !== null) {
                                timeExtent = d3.extent(data, function (d) { // jshint ignore:line
                                    return Date.parse(d.date);
                                });

                                median = d3.median(timeExtent); // jshint ignore:line
                            ...
                            numberFormat = d3.format('.f'); // jshint ignore:line

                            yAxisGen = d3 // jshint ignore:line
                                .svg
                                .axis()
                                .scale(yScale)
                                .orient('left')
                        ...
                        drawPath: function (data, index) {
                            ...
                            function tooltipMouseOver() { // jshint ignore:line
                                var svg = d3 // jshint ignore:line
                                    ...
                                    formatX = moment(xAxisValue).format('dddd, D MMM, YYYY'), // jshint ignore:line
                                    rect,
                                    text,
                            ...
                            function tooltipMouseOut() {
                                var svg = d3.select(_config.rawSvg[0]); // jshint ignore:line
                            ...
                            function mousemove() {
                                ...
                                formatX = moment(d.date).format('dddd, D MMM, YYYY'); // jshint ignore:line
                            ...
                            //find the max data
                            maxData = d3.max(data, function (d) { // jshint ignore:line
                                return d[ykeyVal];
                            });
                            ...
                            if (threshold !== 0 && kpiType.toLowerCase() !== 'impressions') {
                                ...
                                if (_config.isPerformanceChart) {
                                    ...
                                    svg
                                        .on('mousemove', function () {
                                            var xCoord = d3.mouse(this)[0], // jshint ignore:line
                                                yCoord = d3.mouse(this)[1]; // jshint ignore:line

                                            addCrossHair(xCoord, yCoord);
                                        })
                                        .on('mouseover', function () {
                                            d3.selectAll('.crosshair').style('display', 'block'); // jshint ignore:line
                                        })
                                        .on('mouseout', function () {
                                            d3.selectAll('.crosshair').style('display', 'none'); // jshint ignore:line
                                        });
                                }
                                ...
                                svg.append('image')
                                    ...
                                    .attr('xlink:href', assets.target_marker); // jshint ignore:line
                                ...
                                if (kpiType.toLowerCase() === 'impressions') {
                                    //delivery as kpi
                                    maxUpperThreshold = d3.max(data, function (d) { // jshint ignore:line
                                    ...
                                    upperPacingLine = d3 // jshint ignore:line
                                        .svg
                                        .line()
                                        .interpolate('basis')
                                        .x(function (d) {
                                    ...
                                    lowerPacingLine = d3 // jshint ignore:line
                                        .svg
                                        .line()
                                        .interpolate('basis')
                                        .x(function (d) {
                                    ...
                                    drawPolygon = d3 // jshint ignore:line
                                        .svg
                                        .line()
                                        .x(function (d) {
                                    ...
                                    reversePacingLine = d3 // jshint ignore:line
                                        .svg
                                        .line()
                                        .interpolate('basis')
                                        .x(function (d) {
                            ...
                            bisectDate = d3 // jshint ignore:line
                                .bisector(function (d) {
                                    return d.date;
                                })
                                .left;
                            ...
                            if (_config.isPerformanceChart) {
                                ...
                                if (_config.activityList) {
                                    _.each(data, function (seriesData) { // jshint ignore:line
                                        position = 0;

                                        _.each(_config.activityList, function (activityData) { // jshint ignore:line
                                            ...
                                            if (moment(seriesData.date).format('YYYY-MM-DD') === // jshint ignore:line
                                                moment(activityData.created_at) // jshint ignore:line
                                                    .format('YYYY-MM-DD')) {
                                                        ...
                                                        if (findPlacedActivity[actionUTC][checkFlag] !== 'completed') {
                                                            ...
                                                            newActivity = {
                                                                date: _config.parseDate(
                                                                    ...
                                                                    (activityData.created_at).format('YYYY-MM-DD')
                                                                ),
                                                                values: seriesData.values,
                                                                name: activityData.ad_name,
                                                                id: activityData.ad_id + '' + activityData.id,
                            ...
                            if (_config.isPerformanceChart) {
                                xTicks
                                    ...
                                    .call(function (t) {
                                        // for each one
                                        t.each(function () {
                                            var self = d3.select(this), // jshint ignore:line
                        ...
                        setChartParameters: function () {
                            var _config = this.lineChartConfig,
                                ...
                                that = this,
                                parseDate = d3.time.format('%Y-%m-%d').parse; // jshint ignore:line
                        ...
                        chartDataFun: function (lineData, threshold, kpiType, chartFrom, deliveryData) {
                            ...
                            if (kpiType.toLowerCase() === 'impressions') {
                                if (deliveryData) {
                                    ...
                                    // 1 week
                                    weekStart = moment(deliveryData.endDate).subtract(6, 'days'); // jshint ignore:line

                                    weekEnd = moment(deliveryData.endDate); // jshint ignore:line
                    ...
                    chartMouseOver = function (d, _config, that) {
                        ...
                        svg = d3.select(_config.rawSvg[0]); // jshint ignore:line
                        mousePos = d3.mouse(that); // jshint ignore:line
                    ...
                    if ((dataObj.kpiType).toLowerCase() === 'impressions') {
                        ...
                        _.each(chartDataset, function (d) { // jshint ignore:line
                            pacing.push(
                                {
                        ...
                        _.each(reverseUpperPacing, function (p) { // jshint ignore:line
                            pacing.push(
                                {
                                    pacing: p.pacing,
                                    date: p.date
