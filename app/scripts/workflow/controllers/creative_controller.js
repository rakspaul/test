                ...
                if (validTag) {
                    ...
                    for (i = 0; i< formDataObj.length; i++) {
                        if ([
                                ...
                                'creativeSize',
                                'creativeType'
                            ].indexOf(formDataObj[i].name) >= 0) {
                            // contains all indexes of static Markup which will have to be removed before adding
                            // to the list.
                            indexArr.push(i);
                        }
                    }
                    ...
                    postCrDataObj.creativeCustomInputs = _.map(templateArr, function (data) {
                        ...
                        if (d[0] === 'clickthrough_url.clickthrough_url' && data.value !== '') {
                            ...
                            if (validCreativeUrl === false) {
                                $('[name="' + data.name + '"]')
                                    .parent()
                                    .append('<label id="invalidUrl" class="col-sm-12 control-label errorLabel"' +
