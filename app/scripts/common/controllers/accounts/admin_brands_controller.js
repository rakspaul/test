define(['angularAMD', 'common-utils', 'accounts-add-or-edit-advertiser-controller', 'accounts-add-or-edit-brand-controller',
    ...
    angularAMD.controller('AdminAdvertisersController', ['$scope', '$rootScope', '$modal', '$compile', '$filter', 'constants', 'accountsService', 'momentService',
        'loginModel', 'vistoconfig', 'utils', function ($scope, $rootScope, $modal, $compile, $filter, constants, accountsService, momentService,
