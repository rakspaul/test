define(['common', 'common/services/vistoconfig_service', 'common/services/route_resolvers_service', 'reporting/strategySelect/strategy_select_model'], function (angularAMD) {
    'use strict';
    ...
    app
        .config(function ($routeProvider, $httpProvider, routeResolvers) {
            ...
            $routeProvider
                ...
                .when('/a/:accountId/sa/:subAccountId/adv/:advertiserId/b/:brandId/dashboard', angularAMD.route({
                    ...
                    resolve: {
                        header: function ($q, $location, $route, accountService, subAccountService, advertiserModel, brandsModel, $timeout, vistoconfig) {
                            var deferrer = $q.defer(),
                                params = $route.current.params;
