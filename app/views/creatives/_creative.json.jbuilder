...
json.ad_id            creative.ad_assignments.first.try(:ad_id)
json.li_assignment_id creative.lineitem_assignment.try(:id)
json.ad_assignment_id creative.ad_assignments.first.try(:id)
