define(['angularAMD', 'common/services/constants_service', 'workflow/services/workflow_service','workflow/services/platform_custome_module'], function (angularAMD) {
  'use strict';
  angularAMD.controller('BuyingPlatformController',['ui.bootstrap'], function ($scope, $timeout, $modal, $filter, $rootScope, constants, workflowService,platformCustomeModule) {
